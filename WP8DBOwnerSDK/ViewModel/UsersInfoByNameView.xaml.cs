...
{
    public partial class UsersInfoByNameView : PhoneApplicationPage
    {
        DBOwnerSDK dbOwnerSDK = App.dbOwnerSDK;

        public UsersInfoByNameView()
        {
            InitializeComponent();

            methodTitle.Text = "查询指定用户用户信息";
            methodName.Text = "/users/show_by_name";

            dbOwnerSDK.DBOwnerPushViewPage("UsersInfoByNameView");
        }

        protected override void OnNavigatedTo(System.Windows.Navigation.NavigationEventArgs e)
        {
            base.OnNavigatedTo(e);
            DBOwner_UserName.Text = this.NavigationContext.QueryString["name"];
        }
        ...
        public void Seach_Click(object sender, RoutedEventArgs e)
        {
            ...
            string name = DBOwner_UserName.Text;
            ...
            else
            {
                ...
                param.Add(new APIParameter("name", name));
                dbOwnerSDK.DBOwnerAuthGetUserInfoByName(param, DBOwner_GetUserInfoCompletedHandler);
            }
        }
